                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <!--<td><?php //echo $ai_core->aiGetValue(DB_PREFIX . "learning_course_category", "name", "id", $row->cat_id); 
                                                                    ?></td>-->
                                                            <td><?php echo $ai_core->aiGetValue(DB_PREFIX . "learning_course", "name", "id", $row->enrooll_course_id); ?></td>
                                                            <td>
